...
//        webView = findViewById(R.id.web_app);  // Make sure your layout has a WebView with this ID
        ...
        WebViewAssetLoader assetLoader = new WebViewAssetLoader.Builder()
                .setDomain("arabic-ftm-standalone.androidplatform.net") 
        ...
        String appUrl = "https://arabic-ftm-standalone.androidplatform.net/assets/FeedTheMonsterJS/index.html?cr_lang=arabic&cr_user_id=" + pseudoId;
