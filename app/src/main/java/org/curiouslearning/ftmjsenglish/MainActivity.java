package org.curiouslearning.ftmjsenglish;
...
import org.curiouslearning.ftmjsenglish.R;
...
//        webView = findViewById(R.id.web_app);  // Make sure your layout has a WebView with this ID
        ...
        WebViewAssetLoader assetLoader = new WebViewAssetLoader.Builder()
                .setDomain("english-ftm-standalone.androidplatform.net") 
        ...
        String appUrl = "https://english-ftm-standalone.androidplatform.net/assets/FeedTheMonsterJS/index.html?cr_lang=english&cr_user_id=" + pseudoId;
